    ...
    return (
        <div name="contact" className='w-full h-screen bg-gradient-to-b from-black to-blue-500 p-4 text-white'>
            <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
                <div className='pb-8'>
                    <p className='text-4xl font-bold inline border-b-4 border-blue-500 pt-4 mt-4'>Contact</p>
                    <p className='py-6'>Submit a form below to get touch with me</p>
                </div>
<div className='flex justify-center items-center'>
                <form action="https://getform.io/f/41d7df42-0c92-42b6-ae3c-3b908df31ca5" method='POST' className='flex flex-col w-full md:w-1/2'>
